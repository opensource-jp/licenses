...
G.
「オリジナル・ソフトウェア」とは、本契約書に従い、初めに政府機関によってリリースされた、政府機関指定＿＿＿＿＿＿、政府機関表題＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿というコンピューター・ソフトウェアのことです。ソースコード、オブジェクト・コード、付属の文書もこれに含まれます。
